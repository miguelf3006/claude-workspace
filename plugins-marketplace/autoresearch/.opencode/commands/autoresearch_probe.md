...
- `--mode` or `Mode:` — interactive (default, uses question) or autonomous (self-answers from codebase)
...
- **Interactive mode:** present questions via question, collect answers
