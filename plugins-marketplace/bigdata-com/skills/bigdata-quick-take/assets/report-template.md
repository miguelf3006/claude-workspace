# Quick take — report template

Follow this structure. Keep the section order. Where a table or section has no data, write "Not available" rather than dropping it. Add inline citations `[1]`, `[2]` immediately after claims, hyperlinked to the document URL.
...
[1-2 sentences: What should the reader do and why?]

## Sources

List every document referenced, numbered to match the inline citations:
